...
@Component({
  selector: 'app-content-by-category',
  templateUrl: './content-by-category.component.html',
  styleUrls: ['./content-by-category.component.css']
})
export class ContentByCategoryComponent implements OnInit {
  contents: any[] = [];
  categoryID: number = 0;
